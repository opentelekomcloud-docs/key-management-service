...
#. In the row containing the desired key, click **Cancel Deletion**.
   ...
   .. figure:: /_static/images/en-us_image_0000002172817710.png
      :alt: **Figure 1** Canceling the scheduled deletion of a single key
...
#. In the displayed dialog box, click **Yes** to cancel the scheduled deletion for the key.
   ...
   -  If the key is created using KMS generated material, its status becomes **Disabled** after the cancelation. To enable the key, see :ref:`Enabling a Key <kms_01_0034>`.
   -  If the key is created using imported material, its status becomes **Disabled** after the cancelation. To enable the key, see :ref:`Enabling a Key <kms_01_0034>`.
   -  If the key is created using imported material and no key material has been imported for it, its status becomes **Pending import** after the cancelation. To use the key, perform :ref:`Creating CMKs Using Imported Key Material <kms_01_0019>`.
