:original_name: dew_01_0331.html
...
Viewing Traces in CTS
---------------------

#. Click |image1| in the upper left corner and choose **Management & Deployment** > **Cloud Trace Service** from the navigation pane.
...
#. Set filters to search for your desired traces, as shown in :ref:`Figure 1 <dew_01_0331__en-us_topic_0000001784562997_en-us_topic_0179639644_fig139361441134311>`.
   ...
   .. _dew_01_0331__en-us_topic_0000001784562997_en-us_topic_0179639644_fig139361441134311:

   .. figure:: /_static/images/en-us_image_0000002503983905.png
   ...
   .. table:: **Table 1** Trace filtering parameters
      ...
      |                                   |                                                                                                                                                                                       |
      |                                   |    For details about the operations that can be audited for each cloud service, see section "Supported Services and Operations" in *Cloud Trace Service User Guide*.                  |
      |                                   |                                                                                                                                                                                       |
      ...
      |                                   |                                                                                                                                                                                       |
      |                                   | If **trace_type** in a trace is set to **SystemAction**, the operation is triggered by the service and the trace's operator may be empty.                                             |
      +-----------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-  For details about the key fields in the trace structure, see and .

.. |image1| image:: /_static/images/en-us_image_0000002504103827.png
.. |image2| image:: /_static/images/en-us_image_0000002470943984.png
.. |image3| image:: /_static/images/en-us_image_0000002471103956.jpg
.. |image4| image:: /_static/images/en-us_image_0000002503983907.png
.. |image5| image:: /_static/images/en-us_image_0000002504103831.png
