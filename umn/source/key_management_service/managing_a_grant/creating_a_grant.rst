:original_name: dew_01_0096.html
...
#. Click the name of the target custom key to go to its details page and create a grant on it.
...
#. Click **Create Grant**. The **Create Grant** dialog box is displayed.
   ...
   .. figure:: /_static/images/en-us_image_0000002278357089.png
      :alt: **Figure 1** Creating a grant

      **Figure 1** Creating a grant

#. In the dialog box that is displayed, enter the ID of the user to be authorized and select permissions to be granted. For details, see :ref:`Table 1 <dew_01_0096__t4212c2dc877a41ba8f1db3dfa2ed7575>`.
   ...
   .. _dew_01_0096__t4212c2dc877a41ba8f1db3dfa2ed7575:

   .. table:: **Table 1** Parameters for creating a grant
      ...
      +-----------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------+
      | Grant Name            | You can name the grant.                                                                                                                                                                                                                | test                             |
      |                       |                                                                                                                                                                                                                                        |                                  |
      |                       | .. note::                                                                                                                                                                                                                              |                                  |
      |                       |                                                                                                                                                                                                                                        |                                  |
...
.. |image2| image:: /_static/images/en-us_image_0000002479480874.png
