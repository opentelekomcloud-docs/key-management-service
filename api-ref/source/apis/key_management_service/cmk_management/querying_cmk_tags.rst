...
.. table:: **Table 3** Response parameters
   ...
   +-----------------+-----------------+------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | sys_tags        | Yes             | Array of objects | System tag list, which is the value pairs of **key** and **value**.                                                                                                                                                   |
   |                 |                 |                  |                                                                                                                                                                                                                       |
...
:ref:`Table 4 <kms_02_0043__en-us_topic_0112992321_en-us_topic_0112992294_en-us_topic_0079615001_table20596071>` lists the normal status code returned by the response.
