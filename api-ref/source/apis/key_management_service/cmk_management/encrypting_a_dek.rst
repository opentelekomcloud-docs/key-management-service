...
.. table:: **Table 3** Request parameters
   ...
   |                      |                 |                 |                                                                                                                                                                                           |
   |                      |                 |                 | For details, see :ref:`Example <kms_02_0022__en-us_topic_0112992344_section144011443913>`.                                                                                                |
   +----------------------+-----------------+-----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
:ref:`Table 5 <kms_02_0022__en-us_topic_0112992344_en-us_topic_0112992294_en-us_topic_0079615001_table20596071>` lists the normal status code returned by the response.
